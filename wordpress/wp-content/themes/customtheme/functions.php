...
/**
 * This function will add the bootstrap compiled sass file to the the header tag
 */
function add_bootstrap_styles(){
    wp_enqueue_style('styles.css', get_template_directory().'/assets/sass/styles.css');
}
